...
exports.baseOrderSchema = {
    ...
    stop_loss_price: (0, schema_1.baseStringSchema)("Stop loss price, converted from bigint"),
    take_profit_price: (0, schema_1.baseStringSchema)("Take profit price, converted from bigint"),
};
