...
export function useAnalytics(): AnalyticsConfig {
  ...
  return [
    // ─────────────────────────────────────────────────────────────
    // Group 1: Forex Withdrawal Status Overview – KPI Grid & Pie Chart
    ...
    [
      {
        ...
        items: [
          ...
          {
            id: "completed_forex_withdrawals",
            title: t("completed"),
            metric: "COMPLETED",
            model: "transaction",
          ...
          {
            id: "cancelled_forex_withdrawals",
            title: t("cancelled"),
            metric: "CANCELLED",
            model: "transaction",
      ...
      },
      {
        ...
        items: [
          {
            id: "forex_withdrawal_status_chart",
