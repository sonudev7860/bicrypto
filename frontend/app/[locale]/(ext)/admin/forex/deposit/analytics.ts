...
export function useAnalytics(): AnalyticsConfig {
  ...
  return [
    // ─────────────────────────────────────────────────────────────
    // Group 1: Forex Deposit Status Overview – KPI Grid & Pie Chart
